...
export const ITEM_DEFS = {
    ...
    lightVest: {
        id: 'lightVest',
        name: '轻型防弹背心',
        type: ITEM_TYPES.PILOT_GEAR,
        width: 2,
        height: 2,
        maxStack: 1,
        rarity: 'common',
        icon: '🦺',
        description: '基础防弹衣，减少飞行员受到的 10% 伤害',
        gearType: 'armor',
    ...
    tacticalVest: {
        ...
        rarity: 'uncommon',
        icon: '🛡️',
        description: '强化防弹衣，减少飞行员受到的 20% 伤害',
        gearType: 'armor',
        effect: { damageReduction: 0.2 },
        weight: 4.0
    },
    heavyPlateCarrier: {
        id: 'heavyPlateCarrier',
        name: '重型插板背心',
        type: ITEM_TYPES.PILOT_GEAR,
        width: 2,
        height: 3,
        ...
        rarity: 'rare',
        icon: '👕',
        description: '重型防护，减少飞行员受到的 35% 伤害，但略微降低移动速度',
        gearType: 'armor',
    ...
    tacticalHelmet: {
        ...
        rarity: 'uncommon',
        icon: '📡',
        description: '集成通讯与探测设备的头盔',
        gearType: 'helmet',
        effect: { damageReduction: 0.08, detectionRange: 50 },
        weight: 2.0
    },
    heavyHelmet: {
        id: 'heavyHelmet',
    ...
    pistol: {
        ...
        rarity: 'common',
        icon: '🔫',
        description: '飞行员的标准自卫武器',
        gearType: 'weapon',
        effect: { damage: 8, fireRate: 20, range: 180 },
        weight: 1.2
    },
    smg: {
        id: 'smg',
        ...
        rarity: 'uncommon',
        icon: '🔫',
        description: '适合近距离作战的自动武器',
        gearType: 'weapon',
        effect: { damage: 6, fireRate: 10, range: 220 },
        weight: 2.5
    },
    shotgunPilot: {
        id: 'shotgunPilot',
        ...
        gearType: 'weapon',
        effect: { damage: 18, fireRate: 45, range: 140, pelletCount: 4 },
        weight: 3.0
    },
    assaultRifle: {
        id: 'assaultRifle',
        ...
        rarity: 'rare',
        icon: '🔫',
        description: '中距离全自动步枪',
        gearType: 'weapon',
        effect: { damage: 12, fireRate: 14, range: 320 },
        weight: 3.5
    },
    sniperRifle: {
        id: 'sniperRifle',
        ...
        description: '远距离精准武器',
        gearType: 'weapon',
        effect: { damage: 35, fireRate: 70, range: 500 },
        weight: 5.0
    },
    ...
    redDotSight: {
        ...
        rarity: 'common',
        icon: '🔴',
        description: '小幅提升射击精准度',
        gearType: 'attachment',
        effect: { spreadReduction: 0.15 },
        weight: 0.3
    },
    scope4x: {
        id: 'scope4x',
    ...
    extendedMag: {
        ...
        rarity: 'common',
        icon: '📎',
        description: '减少换弹频率，略微提升射速',
        gearType: 'attachment',
        effect: { fireRateBoost: 0.1 },
        weight: 0.3
    },
    suppressor: {
        id: 'suppressor',
        ...
        rarity: 'uncommon',
        icon: '📯',
        description: '降低枪声，减少吸引敌人的范围',
        gearType: 'attachment',
        effect: { noiseReduction: 0.5 },
        weight: 0.4
    },
    laserPointer: {
        id: 'laserPointer',
        ...
        description: '近距离散布减少',
        gearType: 'attachment',
        effect: { spreadReduction: 0.2, rangeLimit: 200 },
        weight: 0.2
    },
    foregrip: {
        id: 'foregrip',
        ...
        rarity: 'common',
        icon: '🧤',
        description: '提升武器操控性，减少后坐',
        gearType: 'attachment',
        effect: { recoilReduction: 0.2 },
        weight: 0.3
    },
    ...
    smallBackpack: {
        ...
        rarity: 'common',
        icon: '🎒',
        description: '增加 4 格飞行员背包空间',
        gearType: 'backpack',
        effect: { inventorySlots: 4 },
        weight: 1.0
    },
    tacticalBackpack: {
        id: 'tacticalBackpack',
    ...
    largeBackpack: {
        ...
        rarity: 'rare',
        icon: '🎒',
        description: '增加 14 格飞行员背包空间',
        gearType: 'backpack',
        effect: { inventorySlots: 14 },
        weight: 3.5
    },
    chestRig: {
        id: 'chestRig',
        ...
        rarity: 'uncommon',
        icon: '👝',
        description: '快速取用弹匣与消耗品，减少 10% 换弹时间',
        gearType: 'chestRig',
        effect: { reloadSpeed: 0.1 },
        weight: 1.5
    },
    heavyChestRig: {
        id: 'heavyChestRig',
        ...
        rarity: 'rare',
        icon: '🎽',
        description: '携带更多弹药与投掷物，减少 20% 换弹时间',
        gearType: 'chestRig',
        effect: { reloadSpeed: 0.2, extraAmmo: 0.2 },
        weight: 3.0
    },
    medicalPouch: {
        id: 'medicalPouch',
